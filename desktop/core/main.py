...
def license_activate(req: LicenseActivateRequest):
  ...
  import re as _re
  PERM_RE = _re.compile(r'^JARVIS-PERM-[A-Z0-9]{4}-[A-Z0-9]{4}
...
if __name__ == "__main__":
  ...
  TRIAL_RE = _re.compile(r'^JARVIS-[A-Z0-9]{4}-[A-Z0-9]{4}-[A-Z0-9]{4}
...
if __name__ == "__main__":
  ...
  is_perm = bool(PERM_RE.match(key))
  is_demo = key == "JARVIS-DEMO-TEST-2024"
  is_trial = bool(TRIAL_RE.match(key)) or is_demo
